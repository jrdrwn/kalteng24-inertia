...
export default function AboutUs({
    ...
    const aboutUsContent = metadata.about_us_content?.trim();
            ...
            <section className="px-2 py-10 md:px-4">
                <div className="container mx-auto">
                    <Card className="mx-auto prose max-w-6xl gap-0 px-4 dark:prose-invert">
                        {aboutUsContent ? (
                            <div>{parse(aboutUsContent)}</div>
                        ) : (
                            <>
                                <h2>TENTANG KAMI</h2>
                                <p>
                                    <b>KALTENG24.COM</b> merupakan portal berita
                                    yang lahir dan berdiri di tengah era arus
                                    informasi yang begitu pesat di bawah naungan{' '}
                                    <b>PT. Kalteng Dua Empat Medianet</b> yang
                                    telah disahkan oleh <b>Kemenkumham RI</b>{' '}
                                ...
                                <p>
                                    ...
                                    Barat - Lamandau - Sukamara - Katingan -
                                    Pulang Pisau - Kapuas - Gunung Mas - Barito
                                    Utara - Barito Selatan - Barito Timur -
                                    Murung Raya
                                    <br />
                                    Jakarta - IKN - Kaltim - Kaltara - Kalsel -
                                    Kalbar
                                    <br />
                                    <br />
                                    BAGIAN UMUM
