...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('config', function (Blueprint $table) {
            $table->longText('about_us_content')->nullable()->after('alamat');
            $table->longText('disclaimer_content')->nullable()->after('about_us_content');
            $table->longText('pedoman_media_siber_content')->nullable()->after('disclaimer_content');
        });

        $aboutUsContent = <<<'HTML'
<h2>TENTANG KAMI</h2>
<p><b>KALTENG24.COM</b> merupakan portal berita yang lahir dan berdiri di tengah era arus informasi yang begitu pesat di bawah naungan <b>PT. Kalteng Dua Empat Medianet</b> yang telah disahkan oleh <b>Kemenkumham RI</b> dengan nomor Keputusan: <b>NOMOR AHU-0264681.AH.01.11.TAHUN 2022</b> berkantor pusat di <b>{metadata.alamat}</b></p>
